...
describe('criar curso via catálogo', () => {
	...
	//TODO: Implementar Catálogo "Em desenvolvimento" e "Suspenso" que não possuem a opção de criar cursos
	//TODO: Implementar a criação de um curso via catálogo editando campos já na criação
	//TODO: Implementar a exclusão de catálogo após a criação do curso e depois editar e excluir o curso criado com base no catálogo

	it.only('5-CRUD deve criar um curso via catálogo que estava em desenvolvimento editado para liberado', () => {
		// Gerando nome aleatório
		const eventName = faker.commerce.productName()
	...
	//TODO: Implementar a criação de um catálogo via front como pré-condição com todos os campos preenchidos para validar a criação do curso via catálogo
})